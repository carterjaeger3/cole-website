...
// The "books" collection now covers books, podcasts, videos, and articles.
export const MEDIA_TYPES = ['book', 'podcast', 'video', 'article'];
...
export const DEFAULTS = {
  ...
  books: [
    { id: 'b-seed-1', title: 'Introduction to the Devout Life', creator: 'St. Francis de Sales', summary: 'Practical and gentle — a good companion for anyone trying to grow in holiness in the middle of a busy, ordinary life.', content: 'Practical and gentle — a good companion for anyone trying to grow in holiness in the middle of a busy, ordinary life.', image_urls: [], type: 'book', link: '' },
    { id: 'b-seed-2', title: 'He Leadeth Me', creator: 'Fr. Walter Ciszek, S.J.', summary: 'A hard, honest account of finding God’s presence in suffering. Reread this before every mission trip.', content: 'A hard, honest account of finding God’s presence in suffering. Reread this before every mission trip.', image_urls: [], type: 'book', link: '' },
    { id: 'b-seed-3', title: 'The Screwtape Letters', creator: 'C.S. Lewis', summary: 'Sharp, funny, and uncomfortably accurate about the small ways we talk ourselves out of holiness.', content: 'Sharp, funny, and uncomfortably accurate about the small ways we talk ourselves out of holiness.', image_urls: [], type: 'book', link: '' },
  ],
  verses: [
...
const TABLE_CONFIG = {
  ...
  books:       { ascending: true,  fields: ['title', 'creator', 'summary', 'content', 'image_urls', 'type', 'link'] },
